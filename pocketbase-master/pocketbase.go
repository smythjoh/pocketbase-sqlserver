...
type PocketBase struct {
	...
	// SqlServerDB is an optional SQL Server connection that can be used by the app.
	sqlServerDB *sql.DB
}
...
func NewWithConfig(config Config) *PocketBase {
	...
	// initialize the sqlServerDB connection
	...
	pb.sqlServerDB = sqlDB

	return pb
}

func (pb *PocketBase) SqlServerDB() *sql.DB {
	return pb.sqlServerDB
}
